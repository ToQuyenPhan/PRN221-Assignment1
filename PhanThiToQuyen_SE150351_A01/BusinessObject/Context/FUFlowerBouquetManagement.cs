...
{
    public partial class FUFlowerBouquetManagement : DbContext
    {
        public FUFlowerBouquetManagement()
        {
        }

        public FUFlowerBouquetManagement(DbContextOptions<FUFlowerBouquetManagement> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=LAPTOP-2OUKCMQB\\SQLEXPRESS;Initial Catalog=FUFlowerBouquetManagement;Persist Security Info=True;User ID=quyen;Password=123456;MultipleActiveResultSets=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OrderDetail>(entity =>
            {
                entity.HasKey(e => new { e.OrderId, e.FlowerBouquetId })
                    .HasName("PK__OrderDet__C983CA9F03111F29");
